...
final class GZipResponseUtil {
	 ...
	 * </p>
	 * <p>
	 * On a unix system to reproduce do <code>gzip -n empty_file</code>. -n tells gzip to not include the file name. The resulting file size is 20 bytes.
	 * </p>
	...
	/**
	 * Checks whether a gzipped body is actually empty and should just be zero. When the compressedBytes is {@link #EMPTY_GZIPPED_CONTENT_SIZE} it should be
	 * zero.
	 *
	 ...
	 * <ol>
	 * <li>If the response code is {@link javax.servlet.http.HttpServletResponse#SC_NO_CONTENT} then it is illegal for the body to contain anything. See
	 * http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.2.5
	 * <li>If the response code is {@link javax.servlet.http.HttpServletResponse#SC_NOT_MODIFIED} then it is illegal for the body to contain anything. See
